...
public class SkillTreeEditorWindow : EditorWindow
{
    ...
    private void ImportFromCsv()
    {
        ...
        for (int i = 1; i < lines.Length; i++)
        {
            ...
            // TODO parse every single property. For example:
            //bool.TryParse(cols[8].Trim(), out bool unlocksDash);
            ...
            SkillTreeNodeEntry newNode = new SkillTreeNodeEntry
            {
                ...
                // TODO add every single property.
            };
    ...
    private void ExportToCsv()
    {
        ...
        foreach (SkillTreeNodeEntry node in skillTreeData.nodes)
        {
            sb.AppendLine(string.Join(",", new string[]
            {
                ...
                // TODO add every single property to string.
            }));
        }
